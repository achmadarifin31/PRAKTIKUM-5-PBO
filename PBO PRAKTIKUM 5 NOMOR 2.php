<!-- Nama: Achmad Nurs Syururi Arifin -->
<!-- NIM: 21091397024 -->
<!-- Kelas: 2021 B -->
...
class Bayaran
{
	...
	{
		echo "Achmad Nurs Syururi Arifin - 21091397024 - Kelas B";
        echo "<br>";
		$man = new Manajer("Piel", 1000000, 1000000);
        echo "<br>", "<br>";
		$prog = new Programmer("Arifin", 600000, 600000); 
        echo "<br>", "<br>";
		$hr = new Bayaran();
